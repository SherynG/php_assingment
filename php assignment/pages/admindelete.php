...
echo '<div style="text-align: center; margin-bottom: 20px;"><a href="/admin/manage-users" style="padding: 10px 20px; background-color: #007BFF; color: white; text-decoration: none; border-radius: 5px;">Manage Users</a></div>';
...
try {
    ...
    foreach ($books as $b) {
        echo '<option value="' . htmlspecialchars($b['id']) . '">' . htmlspecialchars($b['title']) . '</option>';
    }
    echo '</select>
